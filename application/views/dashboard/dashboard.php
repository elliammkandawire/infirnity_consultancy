			 ...
			 <div class="w3-card-16">
					    <header class="w3-container w3-blue">
							<h5>Company Details</h5>
							 <button style="margin-bottom: 10px" class="btn btn-danger" data-toggle="modal" data-target="#edit_password" data-whatever="@mdo"><i class="fa fa-plus"></i> Password</button>
						</header>
						<br>
        ...
        <div class="row">
        	 <div class="col-lg-6">
				 ...
				 <div class="form-group">
					 ...
					 <input type="tel" class="form-control" value="<?php echo $data->cell ?>" name="phone" placeholder="Ground Phone Number" required="">
				 </div>
        	 ...
        	 <div class="col-lg-6">
				 ...
				 <div class="form-group">
				  ...
				  <div class="form-group">
		            ...
		            <textarea class="form-control summernote"  name="address" required="" style="white-space: pre-wrap;" rows="7"><?php echo $data->address ?></textarea>
		          </div>
