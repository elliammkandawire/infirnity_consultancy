                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        <?php foreach($pagenation as $page_number): ?>
                            <li class="page-item <?php if($page==$page_number){ echo "active";} ?>"><a class="page-link active" href="<?php echo base_url() ?>slider?page=<?php echo $page_number ?>"><?php echo $page_number ?></a></li>
    ...
    <div id="container" style="width: 100%;">
        <?php foreach($data as $item): ?>
            <div class="gallery w3-container">
                <a target="_blank" href="<?php echo base_url(); ?>images\slider\<?php echo $item->picture; ?>">
                    <img src="<?php echo base_url(); ?>images\slider\<?php echo $item->picture; ?>" alt="" style="object-fit: cover; height: 200px;" >
                </a>
                ...
                <div class="container">
                    ...
                    <button class="btn btn-warning btn-sm" onclick="delete_('<?php echo $item->slug; ?>','<?php echo $item->title; ?>','Confirm deleting Slider with name ','slider/delete')"><i class="fa fa-trash"></i></button>
                </div>
            </div>
        <?php endforeach; ?>
    </div>
                ...
                <form method="POST" action="update_slider" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label for="message-text" class="col-form-label">Details</label>
                                <textarea class="form-control summernote" rows="16" name="description" id="description"></textarea>
                            </div>
